...
export default function SignUp() {
  ...
  const getSelectedRoleDescription = () => {
    const selectedRoleObj = roles.find(r => r.value === formData.role);
    return selectedRoleObj?.description || "";
  };
  return (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  minLength={6}
                  className="w-full px-4 py-3 rounded-xl border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all duration-300 pr-12"
                />
                <button
                  type="button"
