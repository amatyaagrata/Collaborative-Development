...
const navItems = [
  { label: "Dashboard", href: "/supplier/dashboard", Icon: LayoutDashboard, description: "Overview & metrics" },
  { label: "Products",  href: "/supplier/products",  Icon: Package, description: "Manage your products" },
  { label: "Orders",    href: "/supplier/orders",    Icon: ShoppingCart, description: "Track purchase orders" },
  { label: "Routes",    href: "/supplier/routes",    Icon: MapPin, description: "Delivery routes" },
];
...
export default function SupplierLayout({ children }: { children: React.ReactNode }) {
  ...
  const [notifications, setNotifications] = useState([
    ...
    { id: 2, title: "Order Approved", message: "Order #PO-12340 has been approved", time: "1 hour ago", read: false, type: "order" },
    { id: 3, title: "Delivery Scheduled", message: "New delivery route assigned", time: "3 hours ago", read: true, type: "delivery" }
  ]);
    ...
    const fetchUser = async () => {
      ...
      if (user) {
        ...
        if (data?.name) {
          ...
          setSupplierName(data.name.split(' ')[0]);
        }
      }
    };
    fetchUser();
  ...
  return (
    <div className={`supplier-layout ${darkMode ? 'dark' : ''}`}>
      {/* Desktop Sidebar */}
      <aside className={`supplier-sidebar ${showMobileMenu ? 'mobile-open' : ''}`}>
        <div className="sidebar-header">
          <Link href="/supplier/dashboard" className="logo-container">
        ...
        <div className="user-profile-sidebar">
          ...
          <div className="user-info">
            <p className="user-name">{supplierName || 'Supplier'}</p>
      ...
      <div className="supplier-main">
        <header className={`supplier-header ${isScrolled ? 'scrolled' : ''}`}>
              ...
              {showNotifications && (
                <div className="notification-menu">
                  ...
                  <div className="notification-footer">
                    <button onClick={() => handleNavigation('/supplier/notifications')}>
            ...
            <div className="user-dropdown">
              <button onClick={() => setShowMenu(p => !p)} className="user-trigger">
                ...
                <div className="user-details">
                  ...
                  <span className="user-name-header">{supplierName || 'Supplier'}</span>
                </div>
              ...
              {showMenu && (
                <div className="dropdown-menu">
                  <div className="dropdown-header">
                    ...
                    <div>
                      <p className="dropdown-user-name">{supplierName || 'Supplier'}</p>
                      <p className="dropdown-user-org">{supplierEmail || orgName || 'Organization'}</p>
                    </div>
                  </div>
      ...
      <style jsx global>{`
        * {
        ...
        .dark .supplier-header {
          background: rgba(26, 26, 46, 0.95);
          border-bottom-color: rgba(255, 255, 255, 0.05);
        }

        .supplier-header.scrolled {
