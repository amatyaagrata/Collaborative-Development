...
interface SupplierLayoutProps { title: string; children: React.ReactNode; }
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: "#f6f8fc" }}>
      <aside style={{ width: 240, flexShrink: 0, background: "#ffffff", display: "flex", flexDirection: "column", borderRight: "1px solid #e9ecf0", position: "sticky", top: 0, height: "100vh" }}>
        <Link href="/supplier/dashboard" style={{ display: "flex", alignItems: "center", gap: 10, padding: "22px 20px 18px", textDecoration: "none", borderBottom: "1px solid #e9ecf0" }}>
          ...
          <span style={{ marginLeft: "auto", fontSize: "0.55rem", fontWeight: 700, background: "#f3e8ff", color: "#7c3aed", padding: "2px 6px", borderRadius: 4, flexShrink: 0, letterSpacing: "0.06em" }}>SUPPLIER</span>
        </Link>
